            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">ตารางแสดงข้อมูลจุดความร้อน</h4>
                            </div>
                            <div class="content">
                                <table class="table" id="example">
                                    <thead>
                                        <tr>
                                            <th>ละติจูด</th>
                                            <th>ลองจิจูด</th>
                                            <th>ความสว่าง (เคลวิน)</th>
                                            <th>Fire Radiative Power (megawatts)</th>
                                            <th>ค่าความร้อน (%)</th>
                                            <th>วันที่</th>
                                            <th>ดาวเทียม</th>
                                            <th>ตำบล</th>
                                    ...
                                    <tbody>
<?php 
    $sql = pg_query("SELECT * from fire_archive order by acq_date desc limit 500");
    while ( $objQuery = pg_fetch_array($sql) ) {
?>                                        
                                        <tr>
                                            <td><?php echo $objQuery[latitude]; ?></td>
                                            <td><?php echo $objQuery[longitude]; ?></td>
                                            <td><?php echo round($objQuery[brightness],2); ?></td>
                                            <td><?php echo round($objQuery[frp],2); ?></td>
                                            <td><?php echo $objQuery[confidence]; ?></td>
                                            <td><?php echo $objQuery[acq_date]; ?></td>
                                            <td><?php echo $objQuery[satellite]; ?></td>
