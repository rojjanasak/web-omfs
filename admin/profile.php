...
<![endif]-->
 <script language=Javascript>
        ...
        function dochange(src, val) {
             ...
             req.open("GET", "location_user.php?data="+src+"&val="+val); 
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">ข้อมูลส่วนตัว</h4> </div>
                            ...
                            <div class="user-bg"> <img width="100%" height="100%" alt="user" src="../plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="../img/pic_user/<?php echo $objResult[pic_user] ?>" class="thumb-lg img-circle" alt="img"></a>
                                        <h4 class="text-white"><?php echo $objResult[name_user],' ',$objResult[lname_user] ?>   </h4>
                                        <h5 class="text-white">
                                            <a href="" class="btn btn-success" onclick="return popupwin('upload_img.php')">แก้ไขรูปภาพ</a>
                                        </h5> </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <ul class="nav nav-tabs">
                              <li class="active"><a data-toggle="tab" href="#home">แก้ไขข้อมูลทั่วไป</a></li>
                              <li><a data-toggle="tab" href="#menu1">เปลี่ยนแปลง E-mail และรหัสผ่าน</a></li>
                            </ul>

                            <div class="tab-content">
                              <div id="home" class="tab-pane fade in active">
                                       <form class="form-horizontal form-material" action="edit_profile.php">
                                        <div class="form-group">
                                            <label class="col-md-12">ชื่อ</label>
                                            <div class="col-md-12">
                                                <input type="text" class="form-control form-control-line" value="<?php echo $objResult[name_user] ?>" name="name_user"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">นามสกุล</label>
                                            <div class="col-md-12">
                                                <input type="text" class="form-control form-control-line" value="<?php echo $objResult[lname_user] ?>" name="lname_user"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">เบอร์โทรศัพท์</label>
                                            <div class="col-md-12">
                                                <input type="text" class="form-control form-control-line" value="<?php echo $objResult[tel_user] ?>" name="tel_user"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">จังหวัด</label>
                                            <span id="prov_name">
                                                <select class="form-control" id="select" name="prov_name" data-cip-id="cIPJQ342845642">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">อำเภอ</label>
                                                <span id="amphoe_name">
                                                    <select class="form-control" name="amphoe_name" id="select" data-cip-id="cIPJQ342845642">
                              ...
                              <div id="menu1" class="tab-pane fade">
                                     <form class="form-horizontal form-material" action="edit_email.php">
                                        <div class="form-group">
