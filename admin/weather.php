            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">ระบบภูมิอากาศ</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                       
                        <ol class="breadcrumb">
                            <li><a href="./">หน้าแรก</a></li>
                            <li class="active">ระบบภูมิอากาศ</li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                     ...
                     <div class="col-md-12 col-xs-12">
                        <div class="">
                          <iframe src="climsys/" style="width: 100%; height: 650px" frameborder="0" scrolling="no" ></iframe>
                        </div>
                    </div>
