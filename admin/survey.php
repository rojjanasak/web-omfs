            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">ระบบ Mobile Field Survey</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                       
                        <ol class="breadcrumb">
                            <li><a href="./">หน้าแรก</a></li>
                            <li class="active">ระบบ Mobile Field Survey</li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
				<iframe src="map_view.php" style="width: 100%; height: 650px" frameborder="0" scrolling="no" ></iframe>
