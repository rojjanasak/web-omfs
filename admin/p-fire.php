        ...
        <div class="content">
            <div class="container-fluid">
				...
				<ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#home">จุดความร้อน 24 ชม.</a></li>
									<li><a data-toggle="tab" href="#fire2">จุดความร้อนย้อนหลัง 48 ชม.</a></li>
				...
				<div class="tab-content">
									...
									<br/>
                                          <div class="card">
                               <iframe src="fire_modis24.php" name="map_fire" frameborder="0"  width="100%" height="650px" ></iframe>
